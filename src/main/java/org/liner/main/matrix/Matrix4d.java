...
public class Matrix4d extends DoubleMatrix<Matrix4d, Matrix4d> implements SquareMatrix<Double, Matrix4d> {
    public double
            m11, m12, m13, m14,
            m21, m22, m23, m24,
            m31, m32, m33, m34,
    ...
    public Matrix4d(float m00, float m01, float m02, float m03,
    ...
    @Override
    public void copy(Matrix4d copy) {
    ...
    @Override
    public Matrix4d abs(Matrix4d pointer) {
    ...
    @Override
    public Matrix4d add(double value) {
    ...
    @Override
    public Matrix4d add(double value, Matrix4d pointer) {
    ...
    @Override
    public Matrix4d add(Matrix4d value) {
    ...
    @Override
    public Matrix4d add(Matrix4d value, Matrix4d pointer) {
    ...
    @Override
    public Matrix4d sub(double value) {
        this.m11 -= value; this.m12 -= value; this.m13 -= value; this.m14 -= value;
        this.m21 -= value; this.m22 -= value; this.m23 -= value; this.m24 -= value;
        this.m31 -= value; this.m32 -= value; this.m33 -= value; this.m34 -= value;
        this.m41 -= value; this.m42 -= value; this.m43 -= value; this.m44 -= value;
    ...
    @Override
    public Matrix4d sub(double value, Matrix4d pointer) {
        pointer.m11 = m11 - value; pointer.m12 = m12 - value; pointer.m13 = m13 - value; pointer.m14 = m14 - value;
        pointer.m21 = m21 - value; pointer.m22 = m22 - value; pointer.m23 = m23 - value; pointer.m24 = m24 - value;
        pointer.m31 = m31 - value; pointer.m32 = m32 - value; pointer.m33 = m33 - value; pointer.m34 = m34 - value;
        pointer.m41 = m41 - value; pointer.m42 = m42 - value; pointer.m43 = m43 - value; pointer.m44 = m44 - value;
    ...
    @Override
    public Matrix4d sub(Matrix4d value) {
        this.m11 -= value.m11; this.m12 -= value.m12; this.m13 -= value.m13; this.m14 -= value.m14;
        this.m21 -= value.m21; this.m22 -= value.m22; this.m23 -= value.m23; this.m24 -= value.m24;
        this.m31 -= value.m31; this.m32 -= value.m32; this.m33 -= value.m33; this.m34 -= value.m34;
        this.m41 -= value.m41; this.m42 -= value.m42; this.m43 -= value.m43; this.m44 -= value.m44;
    ...
    @Override
    public Matrix4d sub(Matrix4d value, Matrix4d pointer) {
        pointer.m11 = m11 - value.m11; pointer.m12 = m12 - value.m12; pointer.m13 = m13 - value.m13; pointer.m14 = m14 - value.m14;
        pointer.m21 = m21 - value.m21; pointer.m22 = m22 - value.m22; pointer.m23 = m23 - value.m23; pointer.m24 = m24 - value.m24;
        pointer.m31 = m31 - value.m31; pointer.m32 = m32 - value.m32; pointer.m33 = m33 - value.m33; pointer.m34 = m34 - value.m34;
        pointer.m41 = m41 - value.m41; pointer.m42 = m42 - value.m42; pointer.m43 = m43 - value.m43; pointer.m44 = m44 - value.m44;
    ...
    @Override
    public Matrix4d mul(double value) {
        this.m11 *= value; this.m12 *= value; this.m13 *= value; this.m14 *= value;
        this.m21 *= value; this.m22 *= value; this.m23 *= value; this.m24 *= value;
        this.m31 *= value; this.m32 *= value; this.m33 *= value; this.m34 *= value;
        this.m41 *= value; this.m42 *= value; this.m43 *= value; this.m44 *= value;
    ...
    @Override
    public Matrix4d mul(double value, Matrix4d pointer) {
        pointer.m11 = m11 * value; pointer.m12 = m12 * value; pointer.m13 = m13 * value; pointer.m14 = m14 * value;
        pointer.m21 = m21 * value; pointer.m22 = m22 * value; pointer.m23 = m23 * value; pointer.m24 = m24 * value;
        pointer.m31 = m31 * value; pointer.m32 = m32 * value; pointer.m33 = m33 * value; pointer.m34 = m34 * value;
        pointer.m41 = m41 * value; pointer.m42 = m42 * value; pointer.m43 = m43 * value; pointer.m44 = m44 * value;
    ...
    @Override
    public Matrix4d mul(Matrix4d value) {
        final double m00 = this.m11 * value.m11 + this.m12 * value.m21 + this.m13 * value.m31 + this.m14 * value.m41;
        final double m01 = this.m11 * value.m12 + this.m12 * value.m22 + this.m13 * value.m32 + this.m14 * value.m42;
        final double m02 = this.m11 * value.m13 + this.m12 * value.m23 + this.m13 * value.m33 + this.m14 * value.m43;
        final double m03 = this.m11 * value.m14 + this.m12 * value.m24 + this.m13 * value.m34 + this.m14 * value.m44;
        final double m10 = this.m21 * value.m11 + this.m22 * value.m21 + this.m23 * value.m31 + this.m24 * value.m41;
        final double m11 = this.m21 * value.m12 + this.m22 * value.m22 + this.m23 * value.m32 + this.m24 * value.m42;
        final double m12 = this.m21 * value.m13 + this.m22 * value.m23 + this.m23 * value.m33 + this.m24 * value.m43;
        final double m13 = this.m21 * value.m14 + this.m22 * value.m24 + this.m23 * value.m34 + this.m24 * value.m44;
        final double m20 = this.m31 * value.m11 + this.m32 * value.m21 + this.m33 * value.m31 + this.m34 * value.m41;
        final double m21 = this.m31 * value.m12 + this.m32 * value.m22 + this.m33 * value.m32 + this.m34 * value.m42;
        final double m22 = this.m31 * value.m13 + this.m32 * value.m23 + this.m33 * value.m33 + this.m34 * value.m43;
        final double m23 = this.m31 * value.m14 + this.m32 * value.m24 + this.m33 * value.m34 + this.m34 * value.m44;
        final double m30 = this.m41 * value.m11 + this.m42 * value.m21 + this.m43 * value.m31 + this.m44 * value.m41;
        final double m31 = this.m41 * value.m12 + this.m42 * value.m22 + this.m43 * value.m32 + this.m44 * value.m42;
        final double m32 = this.m41 * value.m13 + this.m42 * value.m23 + this.m43 * value.m33 + this.m44 * value.m43;
        final double m33 = this.m41 * value.m14 + this.m42 * value.m24 + this.m43 * value.m34 + this.m44 * value.m44;
        this.m11 = m00;
        this.m12 = m01;
        this.m13 = m02;
        this.m14 = m03;
    ...
    @Override
    public Matrix4d mul(Matrix4d value, Matrix4d pointer) {
    ...
    @Override
    public Matrix4d div(double value) {
        this.m11 /= value; this.m12 /= value; this.m13 /= value; this.m14 /= value;
        this.m21 /= value; this.m22 /= value; this.m23 /= value; this.m24 /= value;
        this.m31 /= value; this.m32 /= value; this.m33 /= value; this.m34 /= value;
        this.m41 /= value; this.m42 /= value; this.m43 /= value; this.m44 /= value;
    ...
    @Override
    public Matrix4d div(double value, Matrix4d pointer) {
        pointer.m11 = m11 / value; pointer.m12 = m12 / value; pointer.m13 = m13 / value; pointer.m14 = m14 / value;
        pointer.m21 = m21 / value; pointer.m22 = m22 / value; pointer.m23 = m23 / value; pointer.m24 = m24 / value;
        pointer.m31 = m31 / value; pointer.m32 = m32 / value; pointer.m33 = m33 / value; pointer.m34 = m34 / value;
        pointer.m41 = m41 / value; pointer.m42 = m42 / value; pointer.m43 = m43 / value; pointer.m44 = m44 / value;
    ...
    @Override
    public Matrix4d div(Matrix4d value) {
        return this.mul(value.copy().invert());
    }

    @Override
    public Matrix4d div(Matrix4d value, Matrix4d pointer) {
        pointer.copy(this);
    ...
    @Override
    public boolean equals(@NotNull Matrix4d value) {
    ...
    public Matrix4d transpose() {
        ...
        final double m14 = this.m41;
        final double m21 = this.m12;
        final double m23 = this.m32;
        final double m24 = this.m42;
        final double m31 = this.m13;
        final double m32 = this.m23;
        final double m34 = this.m43;
        final double m41 = this.m14;
        final double m42 = this.m24;
        final double m43 = this.m34;
        this.m12 = m21;
        this.m13 = m31;
        this.m14 = m41;
        this.m21 = m12;
    ...
    @Override
    public Matrix4d transpose(Matrix4d pointer) {
        pointer.m11 = m11;
        pointer.m12 = m21;
        pointer.m13 = m31;
        pointer.m14 = m41;
    ...
    public Double[] getRow(int index) {
        return switch (index) {
            case 0 -> new Double[]{m11, m12, m13, m14};
            case 1 -> new Double[]{m21, m22, m23, m24};
            case 2 -> new Double[]{m31, m32, m33, m34};
            case 3 -> new Double[]{m41, m42, m43, m44};
            default -> throw new ArrayIndexOutOfBoundsException();
        };
    }
    ...
    public Double[] getColumn(int index) {
        return switch (index) {
            case 0 -> new Double[]{m11, m21, m31, m41};
            case 1 -> new Double[]{m12, m22, m32, m42};
            case 2 -> new Double[]{m13, m23, m33, m43};
            case 3 -> new Double[]{m14, m24, m34, m44};
            default -> throw new ArrayIndexOutOfBoundsException();
        };
    }
    ...
    @Override
    public Matrix4d invert(Matrix4d pointer) {
        pointer.copy(this);
